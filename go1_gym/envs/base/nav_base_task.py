...
class BaseTask(gym.Env):
    ...
    def __init__(self, cfg, sim_params, physics_engine, sim_device, headless, eval_cfg=None):
        ...
        self.num_nav_obs = cfg.env.num_nav_observations # phase2
        # self.num_privileged_obs = cfg.env.num_privileged_obs
        

        self.num_actions = cfg.env.num_actions
        self.num_nav_actions = cfg.env.num_nav_actions # phase2
        ...
        # phase2
        self.nav_obs_buf = torch.zeros(self.num_envs, self.num_nav_obs, device=self.device, dtype=torch.float)
