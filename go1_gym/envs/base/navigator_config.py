...
class Cfg(PrefixProto, cli=False):
    class env(PrefixProto, cli=False):
        num_nav_observations = 21 # phase2
        num_nav_actions = 3 # phase2
        max_episode_length = 500 # phase2
        num_envs = 4096
    ...
    class init_state(PrefixProto, cli=False):
        pos = [0., 0., 0.34]  # x,y,z [m]
        rot = [0., 0., 0., 1.]  # x,y,z,w [quat]
        
        target_pos_shift = [3., 0., 0.]  # x,y,z [m]
        target_rot = [0., 0., 0., 1.]  # x,y,z,w [quat]
    ...
    class reward_scales(ParamsProto, cli=False):
        ...
        orientation_to_target = 0.5

        box = -1.
        wall = -1.
        # nav_action_smoothness = -0.001
        # time_to_target = -0.01
        # high_nav_actions = -0.01
    ...
    class normalization(PrefixProto, cli=False):
        ...
        clip_actions = 100.
        clip_nav_actions_xy = 1.5 # phase2
        clip_nav_actions_yaw = 0.4 # phase2
    ...
    class obs_scales(PrefixProto, cli=False):
        # base_pos = 2.0 # phase2
        # base_quat = 2.0 # phase2
        base_lin_vel = 2.0 # phase2
        base_ang_vel = 1.5 # phase2
        lin_vel = 2.0
        ang_vel = 0.25
        dof_pos = 1.0
        dof_vel = 0.05
