...
class AC_Args(PrefixProto, cli=False):
    ...
    # actor_hidden_dims = [256, 128] # phase2
    # critic_hidden_dims = [256, 128] # phase2
    activation = 'elu'  # can be elu, relu, selu, crelu, lrelu, tanh, sigmoid

    # adaptation_module_branch_hidden_dims = [256, 128] # phase2
...
class ActorCritic(nn.Module):
    ...
    def __init__(self, num_obs,
        ...
        # Policy
        actor_layers = []
        actor_layers.append(nn.Linear(self.num_obs_history, AC_Args.actor_hidden_dims[0])) # phase2
        # actor_layers.append(nn.Linear(self.num_privileged_obs + self.num_obs_history, AC_Args.actor_hidden_dims[0])) # phase2
        ...
        # Value function
        critic_layers = []
        # critic_layers.append(nn.Linear(self.num_privileged_obs + self.num_obs_history, AC_Args.critic_hidden_dims[0])) # phase2
        critic_layers.append(nn.Linear(self.num_obs_history, AC_Args.critic_hidden_dims[0])) # phase2
